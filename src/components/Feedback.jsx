...
export const Feedback =()=> {
  ...
  return (
        <> <div className={css.containerButton}>
          <button type="button" className={css.button1}  onClick={staticChangeGood}>Good</button>
          <button type="button" className={css.button2}  onClick={staticChangeNeutral}>Neutral</button>
          <button type="button" className={css.button3}  onClick={staticCangeBad} >Bad</button>
          </div>
